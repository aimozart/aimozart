...
**AI builder** — Rust, post-quantum crypto, multi-agent systems.
...
Entropa was built solo, end to end, under this handle — real post-quantum cryptography, a live consensus
network, a production AI agent, CI/CD, monitoring, hardening. If one person directing AI at a senior bar can
ship that alone, imagine what it does for your team.

Open to **salaried, full-time** or **per-project / contract** work. For startups, equity is always part of
the package **in addition to** full salary and benefits — never a substitute for either.
